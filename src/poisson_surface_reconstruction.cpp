...
void poisson_surface_reconstruction(const Eigen::MatrixXd& P,
  ...
  // Calculate weight matrices for trilinear interpolation
  ...
  double sigma = 1 / P.rows() *
                 Eigen::VectorXd::Constant(P.rows(), 1.0).transpose() * W * g;
